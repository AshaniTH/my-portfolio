...
const ContactSection = () => {
  ...
  return (
    ...
    >
                ...
                >
                    ...
                    >
                        ...
                        <p className={`text-sm ${
                            ...
                            I'm currently available for fullstack development internship
            ...
            >
                ...
                <p className={`${
                    ...
                    className={`px-6 py-3 rounded-full border font-medium transition-all duration-300 ${
                        isDarkMode ? "borer-gray-600 hover:border-blue-500 hover-text-blue-400" :
        ...
        <SuccessModel
        showSuccess={showSuccess} setShowSuccess={setShowSuccess} isDarkMode={isDarkMode}
        />
